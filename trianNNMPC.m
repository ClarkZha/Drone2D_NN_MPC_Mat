...
dataSet.actionHorizon = 4; %Output horizon of the NN controller
dataSet.X = X;
dataSet.y = y;
...
dataSet.testPercent = 0.05; %Use 10% data to test
...
for i = 1:epochNum
    epochLossList(1,i) = trainInfo.ValidationLoss(1,epochSampleSize*i);
    epochLossList(2,i) = trainInfo.TrainingLoss(1,epochSampleSize*i);
end
...
xlabel('Epoch')
ylabel('Loss')
save('epochLoss.mat','epochLossList')
